       ...
       <?php 
		...
		<div class="container">
			...
			<div id="contenido">
				...
				<h1 class="titulo-perfil">Explorar</h1>
                <?php
                $recetas = UsuarioReceta::findRecetas();
                if(!empty($recetas)) {
                    foreach ($recetas as $receta) {
                        if ($receta["receta_cocinero"] !== $user->userNickname()) {
                            /*echo '<div class="recetaInfo">' . $receta["receta_nombre"] . '</div>';*/
